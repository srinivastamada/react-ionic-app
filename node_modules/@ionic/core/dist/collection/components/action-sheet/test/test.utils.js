...
export async function testActionSheet(type, selector, rtl = false, afterScreenshotHook = async (..._args) => { }) {
    try {
...
export async function testActionSheetBackdrop(page, screenshotCompares, actionSheet) {
    try {
...
export async function testActionSheetAlert(page, screenshotCompares) {
    try {
