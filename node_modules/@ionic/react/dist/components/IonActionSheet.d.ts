...
export declare type ActionSheetOptions = Components.IonActionSheetAttributes;
declare const IonActionSheet: {
    new (props: Components.IonActionSheetAttributes & {
        ...
        context: any;
        setState<K extends never>(state: {} | ((prevState: Readonly<{}>, props: Readonly<Components.IonActionSheetAttributes & {
            children: import("react").ReactNode;
            isOpen: boolean;
            onDidDismiss: (event: CustomEvent<import("@ionic/core").OverlayEventDetail<any>>) => void;
        ...
        readonly props: Readonly<{
            children?: import("react").ReactNode;
        }> & Readonly<Components.IonActionSheetAttributes & {
            children: import("react").ReactNode;
            isOpen: boolean;
            onDidDismiss: (event: CustomEvent<import("@ionic/core").OverlayEventDetail<any>>) => void;
        }>;
        ...
        shouldComponentUpdate?(nextProps: Readonly<Components.IonActionSheetAttributes & {
            children: import("react").ReactNode;
            isOpen: boolean;
            onDidDismiss: (event: CustomEvent<import("@ionic/core").OverlayEventDetail<any>>) => void;
        ...
        getSnapshotBeforeUpdate?(prevProps: Readonly<Components.IonActionSheetAttributes & {
            children: import("react").ReactNode;
            isOpen: boolean;
            onDidDismiss: (event: CustomEvent<import("@ionic/core").OverlayEventDetail<any>>) => void;
        ...
        componentWillReceiveProps?(nextProps: Readonly<Components.IonActionSheetAttributes & {
            children: import("react").ReactNode;
            isOpen: boolean;
            onDidDismiss: (event: CustomEvent<import("@ionic/core").OverlayEventDetail<any>>) => void;
